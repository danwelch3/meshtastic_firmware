...
AccelerometerThread::AccelerometerThread(ScanI2C::DeviceType type) : OSThread("AccelerometerThread")
{
    ...
    if (accelerometer_type == ScanI2C::DeviceType::MPU6050 && mpu.begin(accelerometer_found.address)) {
    ...
    } else if (accelerometer_type == ScanI2C::DeviceType::BMA423 && bmaSensor.begin(readRegister, writeRegister, delay)) {
...
int32_t AccelerometerThread::runOnce()
{
    ...
    } else if (accelerometer_type == ScanI2C::DeviceType::BMA423 && bmaSensor.getINT()) {
