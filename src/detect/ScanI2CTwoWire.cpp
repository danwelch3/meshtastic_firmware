...
void ScanI2CTwoWire::scanPort(I2CPort port)
{
    ...
    for (addr.address = 1; addr.address < 127; addr.address++) {
        ...
        if (err == 0) {
            ...
            SCAN_SIMPLE_CASE(BNO08x_ADDR, BNO08x, "BNO08x sensor found\n");
            // case BNO08x_ADDR:
                // registerValue = getRegisterValue(ScanI2CTwoWire::RegisterLocation(addr, 0xF9), 1);
                // LOG_DEBUG("BNO08x register value = 0x%x\n", registerValue);
            ...
            SCAN_SIMPLE_CASE(BNO08x_ADDR_ALTERNATE, BNO08x, "BNO08x sensor found\n");
